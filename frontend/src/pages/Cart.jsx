...
function Cart() {
    ...
    useEffect(() => {
        const fetchCart = async () => {
            try {
                ...
                const response = await axios.get('https://kitaab-lele-iyj9-shiv459s-projects.vercel.app/api/v1/getcart', { headers });
    ...
    const handlePlaceOrder = async () => {
        try {
            ...
            const response = await axios.post('https://kitaab-lele-iyj9-shiv459s-projects.vercel.app/api/v1/placeorder', { order: cart }, { headers });
